...
if (JVERSION < 5) :
	$url_permalink = Route::_(ContentHelperRoute::getArticleRoute($this->item->slug, $this->item->catid, $this->item->language), true, 0, 1);
else :
	$uri_permalink = clone Uri::getInstance();
	$url_permalink = htmlspecialchars($uri_permalink->toString(), ENT_COMPAT, 'UTF-8');
endif;

?>
	<div class="uk-article" itemscope itemtype="https://schema.org/Article" data-permalink="<?php echo $url_permalink; ?>">
