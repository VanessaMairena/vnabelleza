...
$scssVars['topbar_link_color'] = $scssVars['topbar_link_color'] ?? '#ffffff';
$scssVars['topbar_link_hover_color'] = $scssVars['topbar_link_hover_color'] ?? '#f6f5f5';
$scssVars['header_top_bg_color'] = $scssVars['header_top_bg_color'] ?? '#FFFFFF';
$scssVars['header_bottom_bg_color'] = $scssVars['header_bottom_bg_color'] ?? '#FFFFFF';
$scssVars['header_bg_mobile_color'] = $scssVars['header_bg_mobile_color'] ?? '#FFFFFF';
$scssVars['logo_text_mobile_color'] = $scssVars['logo_text_mobile_color'] ?? '#020d26';
$scssVars['toggle_mobile_color'] = $scssVars['toggle_mobile_color'] ?? '#020d26';
$scssVars['toggle_mobile_hover_color'] = $scssVars['toggle_mobile_hover_color'] ?? '#0b3d24';
$scssVars['bottom_bg_color'] = $scssVars['bottom_bg_color'] ?? '#FFFFFF';
$scssVars['bottom_title_color'] = $scssVars['bottom_title_color'] ?? '#020e28';
$scssVars['bottom_text_color'] = $scssVars['bottom_text_color'] ?? '#020e28';
$scssVars['bottom_link_color'] = $scssVars['bottom_link_color'] ?? '#020e28';
$scssVars['bottom_link_hover_color'] = $scssVars['bottom_link_hover_color'] ?? '#0b3d24';
